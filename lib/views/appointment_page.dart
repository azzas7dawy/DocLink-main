                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage("lib/assets/assets_images/doctor1.jpg"),
                        fit: BoxFit.cover),
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      boxShadow: [
                                        BoxShadow(
                                          color: Color.fromARGB(134, 100, 48, 48)
                                              .withOpacity(0.9),
                                          blurRadius: 4,
                                          spreadRadius: 2,
                                        )
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        color: Color.fromARGB(135, 187, 174, 174)
                                            .withOpacity(0.9),
                                        blurRadius: 4,
                                        spreadRadius: 2,
                                      ),
                                  ...
                                  child: Center(
                                    child: Icon(
                                      ...
                                      color: const Color.fromARGB(255, 216, 158, 158),
                                      size: 28,
                                    ),
                                  ),
                                ),
                          ...
                          return SizedBox(
                            ...
                            //   child:
                               Container(
                                ...
                                decoration: BoxDecoration(
                                    color: index == 1 ? Color.fromARGB(255, 64, 91, 119) : Color.fromARGB(255, 35, 18, 18),
                                    borderRadius: BorderRadius.circular(10),
                                    boxShadow: [
                                      BoxShadow(
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        color: index == 1
                                            ...
                                            : Color.fromARGB(255, 74, 111, 142).withOpacity(0.6),
                                      ),
                                    )
                                  ],
                                ),
                        ...
                        itemBuilder: (context, index) {
                          return Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    color: const Color.fromARGB(255, 213, 193, 191),
                                    blurRadius: 4,
                                    spreadRadius: 2,
                                  )
                                ]),
